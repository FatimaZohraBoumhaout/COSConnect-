...
function About(){
    return(
        ...
        <center>
            ...
            <p> After filling in your information and the classes you are taking, you will be able to access your "classes" page. This page lists all the classes you are taking. From here, you are able to access further functionalities for each class. </p>
            <br></br><br></br>
            <img src={classes}/>  
            <br></br>
            ...
            <p> Note that you can view your own profile. Furthermore, you can edit your information in your profile page, including what clases you are taking. The profile page can be accessed through the header. You can change a few settings in your profile view. 
            ...
            <br></br>
            <img src={profile}/>
            <p> Through the header, you can also access the classes by pressing the "Classes" (as mentioned prevously), or log out from your princeton account. 
            ...
            <br></br>
            <p> When viewing your sent and received quests, you should expect it to look like this: </p>
            <br></br>
            <p> To edit, simply click "edit". To close without saving, click "close" in the mall. To close with saving, click "save". At this stage, you will need to refill in your information if you click "save". </p>
            <br></br>
            <p>  </p>
            <br></br>
